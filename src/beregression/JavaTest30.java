//VERIFYING IF A WEB ELEMENT IS ENABLED/DISABLED
...
public class JavaTest30 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement returnDateCal = driver.findElement(By.id("ctl00_mainContent_view_date2"));
		System.out.println("Return Date Calender : " +  returnDateCal.isEnabled());
		System.out.println("\n");
		
		WebElement roundTripRB = driver.findElement(By.id("ctl00_mainContent_rbtnl_Trip_1"));
		roundTripRB.click();
		Thread.sleep(1000);
		System.out.println("Return Date Calender after selecting Round Trip RB: " +  returnDateCal.isEnabled());
		
		
		/*
		
		//another way of doing the above step if isEnabled() method is not returning any result
